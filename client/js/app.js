...
function createDataCard(result) {
    ...
    const image = imageUrl ? 
        `<img src="${imageUrl}" alt="${result.title}" class="data-card-image">` : 
        '<div class="data-card-image" style="display: flex; justify-content: center; align-items: center; color: rgba(255, 255, 255, 0.6);">暂无图片</div>';
...
function showDataCardDetail(record) {
    ...
    const image = record.image_url ? 
        `<img src="${record.image_url}" alt="${record.title}" class="data-card-image">` : 
        '<div class="data-card-image" style="display: flex; justify-content: center; align-items: center; color: rgba(255, 255, 255, 0.6);">暂无图片</div>';
